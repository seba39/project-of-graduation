<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Jeddah dest.aspx.vb" Inherits="_Default" %>
...
<header style="max-width:1500px">
  <img class="center" src="pic/Jeddah.jpg" alt="London" height="500" width="1000"  />
  <div class="top-right"><h2>Jeddah</h2></div>
...
<div class="w3-content" style="max-width:1100px;">
  ...
  <div class="w3-row-padding">
    <div class="w3-half w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        <h3>Historical exhibition event</h3>
        <p class="w3-opacity"> SR</p>
        <p>A historical exhibition that tells the story of the Kingdom's founding in a rich historical journey with firm originality until our glorious present</p>
    ...
    <div class="w3-half w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        <h3>The day we started event</h3>
        <p class="w3-opacity"> SR</p>
        <p>An event dedicated to children that inculcates in their minds the authentic Saudi identity of Saudi hospitality and the landmarks and heritage of the nation</p>
      <br />
          <button class="w3-button w3-margin-bottom">Learn more</button>
      </div>
    </div>
