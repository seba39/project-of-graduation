<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Madinah dest.aspx.vb" Inherits="_Default" %>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
     ...
     <a href="Saudi cities.aspx"> <button class="w3-button w3-white">Destenation</button></a>
...
<header style="max-width:1500px">
  <img class="center" src="pic/madinah.jpg" alt="London" height="500" width="1000"  />
  <div class="top-right"><h2>Madinah</h2></div>
...
<div class="w3-content" style="max-width:1100px;">
  ...
  <div class="w3-row-padding">
    <div class="w3-half w3-margin-bottom">
      <img src="pic/Investment Forum for Startups.jpeg" alt="Norway" style="width:100%"/>
      <div class="w3-container w3-white">
        <h3>Investment Forum for Startups</h3>
    ...
    <div class="w3-half w3-margin-bottom">
      <img src="pic/agricultural guide caravan.jpeg" alt="Austria" style="width:70%"/>
      <div class="w3-container w3-white">
        <h3>agricultural guide caravan</h3>
        <p class="w3-opacity"> SR</p>
        <p>..</p>
      <br />
          <button class="w3-button w3-margin-bottom">Learn more</button>
