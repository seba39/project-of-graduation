<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Riyadh dest.aspx.vb" Inherits="_Default" %>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="#portfolio" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Main menu</a> 
...
<header style="max-width:1500px">
  <img class="center" src="pic/Al-Riyad.jpg" alt="London" height="500" width="1000"  />
  <div class="top-right"><h2>Riyadh</h2></div>
...
<div class="w3-content" style="max-width:1100px;">
  ...
  <div class="w3-row-padding">
    <div class="w3-half w3-margin-bottom">
      <img src="pic/تجربة-رامز-780x470.jpeg" alt="Norway" style="width:100%"/>
      <div class="w3-container w3-white">
        <h3>Ramez experince</h3>
        <p class="w3-opacity">70 SR</p>
        <p>Ramez, who was famous for his pranks over the years, invites you this time to participate with him and enter into a new and different interactive experience of funny, exciting pranks.</p>
        <button class="w3-button w3-margin-bottom">Learn more</button>
      </div>
    </div>
    <div class="w3-half w3-margin-bottom">
      <img src="pic/squid game riyadh.jpg" alt="Austria" style="width:100%"/>
      <div class="w3-container w3-white">
        <h3>Squid game</h3>
        <p class="w3-opacity">230 SR</p>
        <p>For the first time in Saudi Arabia, live the excitement and excitement of challenge with the experience inspired by the famous series "Squid Game" now in Riyadh City Boulevard.</p>
      <br />
          <button class="w3-button w3-margin-bottom">Learn more</button>
      </div>
    </div>
