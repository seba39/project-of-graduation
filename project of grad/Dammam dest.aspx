<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Dammam dest.aspx.vb" Inherits="_Default" %>
...
<header style="max-width:1500px">
  <img class="center" src="pic/Webp.net-resizeimage dammam.jpg" alt="London" height="500" width="1000"  />
  <div class="top-right"><h2>Dammam</h2></div>
...
<div class="w3-content" style="max-width:1100px;">
  ...
  <div class="w3-row-padding">
    <div class="w3-half w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        <h3>Eastern Region Literary Club</h3>
